...
class ExpandedPageView extends StatefulWidget {
  ...
  @override
  State<ExpandedPageView> createState() =>
      _ExpandedOnBoardingPageViewState();
}

class _ExpandedOnBoardingPageViewState
    extends State<ExpandedPageView> {
  final List<OnboadingViewItemModel> item = const [
    OnboadingViewItemModel(
      ...
      imageLoge: Assets.assetsImagesOnBording1,
    ...
    OnboadingViewItemModel(
      ...
      imageLoge: Assets.assetsImagesOnBording2,
      title: 'ابحث وتسوق',
      subtitle:
      ...
      itemBuilder: (context, index) => Column(
        children: [
          ...
          Padding(
            ...
            child: Text(item[index].subtitle, style: AppStyle.styleSemiBold13(context) , textAlign: TextAlign.center,),
          ),
        ],
      ),
    );
